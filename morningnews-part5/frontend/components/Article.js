...
function Article(props) {
	...
	const handleBookmarkGoInivisbleClick = () => {
		dispatch(hideArticles(props));
	...
	return (
		<div className={styles.articles}>
			<div className={styles.articleHeader}>
				...
				<FontAwesomeIcon onClick={() => handleBookmarkGoInivisbleClick()} icon={faEyeSlash} className={styles.bookmarkIcon} />
