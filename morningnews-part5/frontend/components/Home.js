...
function Home() {
  ...
  const isShown = articlesData.filter(article => !hiddenArticles.some(hiddenArticles => article.title === hiddenArticles.title))
  //articlesData.some(articlesData => hiddenArticles === data);




  const articles = isShown.map((data, i) => {
